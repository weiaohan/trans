...
dotenv.config()
const PORT = 8011;
const PATH = '/Users/weiaohan/script/trans/dic.md'; // dictionary patj
const FROM = 'en';
const TO = 'zh';
const b_url = 'https://fanyi-api.baidu.com/api/trans/vip/translate';
const APPID = process.env.B_APPID;
const SALT = process.env.B_SALT;
